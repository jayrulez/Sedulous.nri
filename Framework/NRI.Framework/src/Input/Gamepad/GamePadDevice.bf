...
public abstract class GamePadDevice : InputDevice<GamePadButton>
{
	...
	/// </summary>
	public abstract EventAccessor<GamePadButtonPressedEventHandler> ButtonPressed { get; }

	/// <summary>
	/// Occurs when one of the game pad's buttons is released.
	/// </summary>
	public abstract EventAccessor<GamePadButtonReleasedEventHandler> ButtonReleased { get; }

	/// <summary>
	/// Occurs when the value of one of the game pad's axes changes.
	/// </summary>
	public abstract EventAccessor<GamePadAxisEventHandler> AxisChanged { get; }
	...
	/// </summary>
	public abstract EventAccessor<GamePadAxisPressedEventHandler> AxisPressed { get; }

	/// <summary>
	/// Occurs when one of the game pad's axes leaves hte "pressed" state, as determined by
	/// the value of the <see cref="AxisDownThreshold"/> property.
	/// </summary>
	public abstract EventAccessor<GamePadAxisReleasedEventHandler> AxisReleased { get; }

	/// <summary>
	/// Occurs when the value of the game pad's left joystick vector changes.
	/// </summary>
	public abstract EventAccessor<GamePadAxisVectorEventHandler> LeftJoystickVectorChanged { get; }

	/// <summary>
	/// Occurs when the value of the game pad's right joystick vector changes.
	/// </summary>
	public abstract EventAccessor<GamePadAxisVectorEventHandler> RightJoystickVectorChanged { get; }
	...
	protected virtual void OnButtonPressed(GamePadButton button, bool @repeat) =>
		ButtonPressed?.[Friend]Invoke(this, button, @repeat);
	...
	protected virtual void OnButtonReleased(GamePadButton button) =>
		ButtonReleased?.[Friend]Invoke(this, button);
	...
	protected virtual void OnAxisChanged(GamePadAxis axis, float value) =>
		AxisChanged?.[Friend]Invoke(this, axis, value);
	...
	protected virtual void OnAxisPressed(GamePadAxis axis, float value, bool @repeat) =>
		AxisPressed?.[Friend]Invoke(this, axis, value, @repeat);
	...
	protected virtual void OnAxisReleased(GamePadAxis axis, float value) =>
		AxisReleased?.[Friend]Invoke(this, axis, value);
	...
	protected virtual void OnLeftJoystickVectorChanged(Vector2 vector) =>
		LeftJoystickVectorChanged?.[Friend]Invoke(this, vector);
	...
	protected virtual void OnRightJoystickVectorChanged(Vector2 vector) =>
		RightJoystickVectorChanged?.[Friend]Invoke(this, vector);
}