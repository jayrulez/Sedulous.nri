...
using internal NRI.Framework.Input.Touch;
...
public delegate void TouchDownEventHandler(TouchDevice device,
	int64 touchID, int64 fingerID, float x, float y, float pressure);
...
public delegate void TouchMotionEventHandler(TouchDevice device,
	int64 touchID, int64 fingerID, float x, float y, float dx, float dy, float pressure);
...
public delegate void TouchTapEventHandler(TouchDevice device,
	int64 touchID, int64 fingerID, float x, float y);
...
public delegate void MultiGestureEventHandler(TouchDevice device,
	float x, float y, float theta, float distance, int32 fingers);
...
public delegate void DollarGestureEventHandler(TouchDevice device,
	int64 gestureID, float x, float y, float error, int32 fingers);
...
public abstract class TouchDevice : InputDevice
{
	...
	public abstract void BindToWindow(Window window);
	...
	/// <returns>The window-space coordinates which correspond to the specified normalized touch coordinates.</returns>
	public abstract Point2 DenormalizeCoordinates(float x, float y);
	...
	public abstract bool IsActive(int64 touchID);
	...
	public abstract bool TryGetTouch(int64 touchID, out TouchInfo touchInfo);
	...
	public abstract bool WasTapped();
	...
	public abstract bool WasTappedWithin(RectangleF area);
	...
	public abstract bool IsTouchWithin(RectangleF area);
	...
	public abstract bool IsTouchWithin(int64 touchID, RectangleF area);
	...
	public abstract bool IsFirstTouchInGesture(int64 touchID);
	...
	public abstract bool RecordDollarGesture();
	...
	/// </summary>
	public abstract Window BoundWindow { get; }

	/// <summary>
	/// Gets a value indicating whether the device is recording a $1 gesture.
	/// </summary>
	public abstract bool IsRecordingDollarGesture { get; }
	...
	/// </summary>
	public abstract EventAccessor<TouchDownEventHandler> TouchDown { get; }

	/// <summary>
	/// Occurs when a touch input ends.
	/// </summary>
	public abstract EventAccessor<TouchUpEventHandler> TouchUp { get; }

	/// <summary>
	/// Occurs when a touch input moves.
	/// </summary>
	public abstract EventAccessor<TouchMotionEventHandler> TouchMotion { get; }

	/// <summary>
	/// Occurs when a touch input is interpreted as a tap.
	/// </summary>
	public abstract EventAccessor<TouchTapEventHandler> Tap { get; }

	/// <summary>
	/// Occurs when a touch input becomes a long press.
	/// </summary>
	public abstract EventAccessor<TouchLongPressEventHandler> LongPress { get; }

	/// <summary>
	/// Occurs when a multiple-finger touch gesture is performed.
	/// </summary>
	public abstract EventAccessor<MultiGestureEventHandler> MultiGesture { get; }

	/// <summary>
	/// Occurs when a $1 gesture is recorded.
	/// </summary>
	public abstract EventAccessor<DollarGestureRecordedEventHandler> DollarGestureRecorded { get; }

	/// <summary>
	/// Occurs when a $1 gesture is performed.
	/// </summary>
	public abstract EventAccessor<DollarGestureEventHandler> DollarGesture { get; }
	...
	/// <param name="y">The normalized y-coordinate of the touch.</param>
	/// <param name="pressure">The normalized pressure of the touch.</param>
	protected virtual void OnTouchDown(int64 touchID, int64 fingerID, float x, float y, float pressure)
	{
		TouchDown?.[Friend]Invoke(this, touchID, fingerID, x, y, pressure);
	}
	...
	{
		TouchUp?.[Friend]Invoke(this, touchID, fingerID);
	}
	...
	/// <param name="dy">The distance that the touch has moved along the y-axis in normalized coordinates.</param>
	/// <param name="pressure">The normalized pressure of the touch.</param>
	protected virtual void OnTouchMotion(int64 touchID, int64 fingerID, float x, float y, float dx, float dy, float pressure)
	{
		TouchMotion?.[Friend]Invoke(this, touchID, fingerID, x, y, dx, dy, pressure);
	}
	...
	/// <param name="x">The normalized x-coordinate of the tap.</param>
	/// <param name="y">The normalized y-coordinate of the tap.</param>
	protected virtual void OnTap(int64 touchID, int64 fingerID, float x, float y)
	{
		Tap?.[Friend]Invoke(this, touchID, fingerID, x, y);
	}
	...
	/// <param name="y">The normalized y-coordinate of the touch.</param>
	/// <param name="pressure">The normalized pressure of the touch.</param>
	protected virtual void OnLongPress(int64 touchID, int64 fingerID, float x, float y, float pressure)
	{
		LongPress?.[Friend]Invoke(this, touchID, fingerID, x, y, pressure);
	}
	...
	/// <param name="distance">The amount that the fingers pinched during the gesture.</param>
	/// <param name="fingers">The number of fingers involved in the gesture.</param>
	protected virtual void OnMultiGesture(float x, float y, float theta, float distance, int32 fingers)
	{
		MultiGesture?.[Friend]Invoke(this, x, y, theta, distance, fingers);
	}
	...
	{
		DollarGestureRecorded?.[Friend]Invoke(this, gestureID);
	}
	...
	/// <param name="error">The difference between the gesture template and the actual performed gesture; lower is better.</param>
	/// <param name="fingers">The number of fingers used to perform the gesture.</param>
	protected virtual void OnDollarGesture(int64 gestureID, float x, float y, float error, int32 fingers)
	{
		DollarGesture?.[Friend]Invoke(this, gestureID, x, y, error, fingers);
	}
	...
	protected void SetTouchPosition(ref TouchInfo touch, float x, float y, out float dx, out float dy, float pressure)
	{
		dx = x - touch.CurrentX;
		dy = y - touch.CurrentY;
		...
		var distance = (float)Math.Sqrt((dpixels.X * dpixels.X) + (dpixels.Y * dpixels.Y));
	...
	protected void SetTouchIsLongPress(ref TouchInfo touch, bool value)
	{
