...
/// with the Application instance as a result of receiving input for the first time.
/// </summary>
...
/// <summary>
/// Represents the input subsystem.
/// </summary>
public interface IInputManager
{
    ...
    bool IsGamePadConnected(int32 playerIndex);
    ...
    bool IsGamePadRegistered(int32 playerIndex);
    ...
    /// is connected; otherwise, <see langword="false"/></returns>
    bool IsTouchDeviceConnected(int32 index);
    ...
    /// is registered with the context; otherwise, <see langword="false"/></returns>
    bool IsTouchDeviceRegistered(int32 index);
