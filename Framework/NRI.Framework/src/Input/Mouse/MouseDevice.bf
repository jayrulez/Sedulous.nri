...
public abstract class MouseDevice : InputDevice<MouseButton>
{
    ...
    /// </summary>
    public abstract EventAccessor<MouseButtonEventHandler> ButtonPressed{get;}

    /// <summary>
    /// Occurs when a mouse button is released.
    /// </summary>
    public abstract EventAccessor<MouseButtonEventHandler> ButtonReleased{get;}

    /// <summary>
    /// Occurs when a mouse button is clicked.
    /// </summary>
    public abstract EventAccessor<MouseButtonEventHandler> Click{get;}

    /// <summary>
    /// Occurs when a mouse button is double clicked.
    /// </summary>
    public abstract EventAccessor<MouseButtonEventHandler> DoubleClick{get;}

    /// <summary>
    /// Occurs when the mouse is moved.
    /// </summary>
    public abstract EventAccessor<MouseMoveEventHandler> Moved{get;}

    /// <summary>
    /// Occurs when the mouse wheel is scrolled.
    /// </summary>
    public abstract EventAccessor<MouseWheelEventHandler> WheelScrolled{get;}
    ...
    protected virtual void OnButtonPressed(Window window, MouseButton button) =>
        ButtonPressed?.[Friend]Invoke(window, this, button);
    ...
    protected virtual void OnButtonReleased(Window window, MouseButton button) =>
        ButtonReleased?.[Friend]Invoke(window, this, button);
    ...
    protected virtual void OnClick(Window window, MouseButton button) =>
        Click?.[Friend]Invoke(window, this, button);
    ...
    protected virtual void OnDoubleClick(Window window, MouseButton button) =>
        DoubleClick?.[Friend]Invoke(window, this, button);
    ...
    protected virtual void OnMoved(Window window, int32 x, int32 y, int32 dx, int32 dy) =>
        Moved?.[Friend]Invoke(window, this, x, y, dx, dy);
    ...
    protected virtual void OnWheelScrolled(Window window, int32 x, int32 y) =>
        WheelScrolled?.[Friend]Invoke(window, this, x, y);
}