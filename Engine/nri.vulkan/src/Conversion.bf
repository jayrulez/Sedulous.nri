...
public static
{
	...
	public const VkImageCreateFlags[(uint)Format.MAX_NUM] IMAGE_CREATE_FLAGS = .(
	    0, // UNKNOWN,
	...
	public const VkImageType[(uint32)TextureType.MAX_NUM] IMAGE_TYPES = .(
	    .VK_IMAGE_TYPE_1D,
	    .VK_IMAGE_TYPE_2D,
	    .VK_IMAGE_TYPE_3D
	);
	...
	public const TextureType[(uint32)TextureType.MAX_NUM] TEXTURE_TYPE_TABLE = .(
